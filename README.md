...
<p align="center">
  <a href="https://github.com/hmzainjamil/ai_computer_use/stargazers"><img alt="Stars" src="https://img.shields.io/github/stars/hmzainjamil/ai_computer_use?style=for-the-badge&labelColor=0d1117&color=ffd700&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai_computer_use/network/members"><img alt="Forks" src="https://img.shields.io/github/forks/hmzainjamil/ai_computer_use?style=for-the-badge&labelColor=0d1117&color=2ecc71&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai_computer_use/issues"><img alt="Issues" src="https://img.shields.io/github/issues/hmzainjamil/ai_computer_use?style=for-the-badge&labelColor=0d1117&color=ff6b6b&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai_computer_use/pulls"><img alt="PRs" src="https://img.shields.io/github/issues-pr/hmzainjamil/ai_computer_use?style=for-the-badge&labelColor=0d1117&color=9b59b6&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai_computer_use/graphs/contributors"><img alt="Contributors" src="https://img.shields.io/github/contributors/hmzainjamil/ai_computer_use?style=for-the-badge&labelColor=0d1117&color=3498db&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai_computer_use/commits/main"><img alt="Commit activity" src="https://img.shields.io/github/commit-activity/m/hmzainjamil/ai_computer_use?style=for-the-badge&labelColor=0d1117&color=e67e22&logo=git&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai_computer_use/commits/main"><img alt="Last commit" src="https://img.shields.io/github/last-commit/hmzainjamil/ai_computer_use?style=for-the-badge&labelColor=0d1117&color=8e44ad&logo=git&logoColor=white"/></a>
</p>
...
<p align="center">
  ...
  <img alt="Tech" src="https://img.shields.io/badge/Python-yellow?style=flat&labelColor=555"/>
</p>
...
Anthropic's computer-use demo is a Docker container that drives a Linux VM. Cool, useless. This repo gives Claude actual control of your Mac and your iPhone - accessibility taps, real screenshots, real automation.

Under the hood: a tool collection (`src/tools/`) exposes `mac_tool`, `ios_tool`, `device_manager`, `system_tool` plus a `mac_safety` guard that blocks destructive operations. Claude sees screenshots; Claude clicks pixels; Claude reads back state.

Use it to automate everything desktop apps swear can't be scripted: Final Cut Pro, Xcode, Photoshop, Logic, Things, native Mac System Settings - anything with a UI.
...
| | What you get |
|---|---|
| **Platforms** | macOS 14+ . iOS 17+ (real device & simulator) |
| **Entry** | `src/main.py` . `src/ui/streamlit_app.py` |
| **Tools** | mac_tool . ios_tool . device_manager . system_tool . mac_safety |
| **Safety** | `src/tools/mac_safety.py` - blocks rm -rf, sudo, network attacks |
| **API layer** | `src/api/anthropic.py` - streaming + tool-use loop |
| **UI** | Streamlit at `localhost:8501` |
| **LLM** | Claude Sonnet 4.x with computer-use tool spec |
| **Env** | `.env.example` - ANTHROPIC_API_KEY, IOS_DEVICE_UDID |
| **License** | MIT |
...
|---|---|---|
| **Screenshot loop** | auto | Captures screen every step; Claude reasons over pixels. |
| **iOS control** | `device_manager` | Drives real iPhone via USB/wifi accessibility. |
| **Mac safety guard** | `mac_safety.py` | Hard blocks destructive shell commands and system regions. |
| **Streamlit chat** | `streamlit run src/ui/streamlit_app.py` | Talk to Claude; watch it work; intervene anytime. |
| **Tool collection** | `tools/collection.py` | Adds new tools by subclassing `base.BaseTool`. |
| **Cleanup hooks** | `utils/cleanup.py` | Closes Simulators, dumps screenshots, rotates logs on exit. |
...
See [issues](https://github.com/hmzainjamil/ai_computer_use/issues) for granular priorities.
...
See [`CHANGELOG.md`](https://github.com/hmzainjamil/ai_computer_use/blob/main/CHANGELOG.md) where applicable. We follow [Keep a Changelog](https://keepachangelog.com/) and [SemVer](https://semver.org/).
...
[GitHub Issues](https://github.com/hmzainjamil/ai_computer_use/issues). Reproduction steps, expected vs. actual, and your Claude Code / Node / Python version help a lot.
</details>
...
<a href="https://star-history.com/#hmzainjamil/ai_computer_use&Date">
  <img src="https://api.star-history.com/svg?repos=hmzainjamil/ai_computer_use&type=Date" alt="Star History"/>
</a>
...
```bash
git clone https://github.com/hmzainjamil/ai_computer_use.git && cd ai_computer_use
...
```
@misc{ai_computer_use_2025,
  author       = {Hamza Zain Jamil},
  title        = {ai_computer_use},
  year         = {2025},
  howpublished = {https://github.com/hmzainjamil/ai_computer_use}
}
```
