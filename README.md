...
> AI computer use automation — desktop control with Claude
...
|---------|-------------|--------|
| Core — AI foundation for computer-use workflows | Core foundation — the primary abstraction this repo builds on | [docs](#) |
| Execution — task decomposition and computer-use routing | Execution layer — how tasks get decomposed and routed | [docs](#) |
...
```bash
# Quick start
python3 main.py --task "computer-use task here"

# Power user shortcut
python3 main.py --computer-use --fast
...
Use ai_computer_use to automate ai computer use automation — desktop control with claude. Perfect for agencies, freelancers, and AI-first teams running computer-use workflows at scale.
...
```bash
# Add to CLAUDE.md
echo "Auto-activate: computer-use, automation" >> ~/.claude/CLAUDE.md

# Or load skill directly
/load-skill ai_computer_use
```
...
{
  "hooks": {
    "PostToolUse": [{"matcher": "computer-use", "command": "python3 ~/repos/ai_computer_use/main.py"}]
  }
}
```
...
```bash
# Fork and clone
gh repo fork hmzainjamil/ai_computer_use --clone
cd ai_computer_use
